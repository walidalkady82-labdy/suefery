...
class CustomerAppTourScreen extends StatefulWidget {
  const CustomerAppTourScreen({super.key});

  @override
  State<CustomerAppTourScreen> createState() => _CustomerAppTourScreenState();
}

class _CustomerAppTourScreenState extends State<CustomerAppTourScreen> {
