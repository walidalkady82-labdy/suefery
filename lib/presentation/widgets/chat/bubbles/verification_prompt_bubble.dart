...
class VerificationPromptBubble extends StatefulWidget {
  ...
  const VerificationPromptBubble({
    super.key,
    required this.item,
  });

  @override
  State<VerificationPromptBubble> createState() => _VerificationPromptBubbleState();
}

class _VerificationPromptBubbleState extends State<VerificationPromptBubble> {
            ...
            Wrap(
              ...
              children: [
                ...
                ActionChip(
                  ...
                  onPressed: () async {
                    await context.read<AuthCubit>().checkVerificationStatus();
                  },
                ),
              ],
            ),
