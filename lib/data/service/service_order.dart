   ...
   Future<void> updateOrderStatus(String orderId, OrderStatus newStatus) async {
    ...
    try {
      ...
      if (!docSnapshot.exists || docSnapshot.data() == null) {
        ...
        throw DatabaseFailure('Order not found for status update.');
      }
      ...
      if (isTransitionAllowed) {
        ...
        throw DatabaseFailure('Invalid order status transition from ${currentStatus.name} to ${newStatus.name}.');
      }
    } catch (e, s) {
