...
class RepoFirebaseAi implements IRepoFirebaseAi {
  ...
  factory RepoFirebaseAi.create() {
    ...
    final orderModel = FirebaseAI.googleAI().generativeModel(
      ...
      tools: [
        Tool.functionDeclarations([_orderTool]),
      ],
    );
  ...
  Future<Map<String, dynamic>> generateOrderContent(
    ...
    try {
      _log.i('Generating content with Order model (Tools)...');
      ...
      if (functionCalls != null && functionCalls.isNotEmpty) {
        ...
        if (call.name == 'confirmOrder') {
          ...
          _log.i('Gemini Tool call succeeded: confirmOrder');
      ...
      if (text != null) {
        _log.i('Gemini returned a chat response.');
