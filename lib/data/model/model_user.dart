...
class ModelUser extends Equatable {
  ...
  factory ModelUser.fromMap(Map<String, dynamic> map) {
    return ModelUser(
      ...
      userAliveStatus: UserAliveStatus.values.firstWhere((status) => status.name == map['partnerStatus']),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'role': role.name,
      'photoUrl': photoUrl,
      'partnerStatus': userAliveStatus.name,
      'lat': lat,
      'lng': lng,
      'geohash': geohash,
      'fcmToken': fcmToken,
  ...
  ModelUser copyWith({
    ...
    return ModelUser(
      ...
      userAliveStatus: partnerStatus ?? this.userAliveStatus,
      lat: lat ?? this.lat,
      lng: lng ?? this.lng,
  ...
  creationTimestamp, role, photoUrl, userAliveStatus, lat, lng, geohash, fcmToken, bio, address, city, country, postalCode, state, specificPersonaGoal,
  ];
}