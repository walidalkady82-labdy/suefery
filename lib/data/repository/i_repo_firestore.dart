...
abstract class IRepoFirestore {
  ...
  Future<void> addDocument(String collectionPath, Map<String, dynamic> data,{String? id}) ;

  Future<void> addMultipleDocument(String path, List<Map<String, dynamic>> data);
