...
class RepoFirestore with LogMixin implements IRepoFirestore {
  ...
  @override
  Future<void> addDocument(String collectionPath, Map<String, dynamic> data,{String? id}) async {
  ...
  @override
  Future<void> addMultipleDocument(String path, List<Map<String, dynamic>> data) async {
